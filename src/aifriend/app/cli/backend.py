...
def backend_state_verification(ctx: Context) -> None:
    ...
    from aifriend.utils.docker import is_docker_running, get_container
...
def backend_start(port: int = Option(var.BACKEND_PORT, '--port', '-p',
    ...
    from aifriend.config import log
    from aifriend.utils.docker import get_client, get_container, get_image, pull_image
...
def backend_stop(prune: bool = Option(False, '--prune', '-p', is_flag=True,
    ...
    from aifriend.config import log
    from aifriend.utils.docker import get_container
...
def backend_prune(force: bool = Option(False, '--force', '-f', is_flag=True,
    ...
    from aifriend.config import log
    from aifriend.utils.docker import get_container, get_volume
